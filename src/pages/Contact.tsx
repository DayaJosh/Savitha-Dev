...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      await submitLead({ source: "contact", ...form });
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a className="hover:underline" href="mailto:savitha.realtor@gmail.com">savitha.realtor@gmail.com</a>
                </div>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a className="hover:underline" href="tel:+14016540197">+1 (401) 654-0197</a>
                </div>
              </div>
              <div className="flex items-center gap-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="contact-phone" className="block text-xs tracking-widest uppercase text-muted-foreground mb-2">Phone</label>
              <input
                id="contact-phone"
                name="phone"
                type="tel"
            ...
            <div>
              <label htmlFor="contact-interest" className="block text-xs tracking-widest uppercase text-muted-foreground mb-2">I'm interested in</label>
              <select
                id="contact-interest"
                name="interest"
                value={form.interest}
            ...
            <div>
              <label htmlFor="contact-areas" className="block text-xs tracking-widest uppercase text-muted-foreground mb-2">Areas of Interest</label>
              <input
                id="contact-areas"
                name="areas"
                type="text"

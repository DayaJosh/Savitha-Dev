    ...
    <div className="container mx-auto px-6 py-16">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <p className="text-sm opacity-70">savitha.realtor@gmail.com</p>
          <p className="text-sm opacity-70 mt-1">+1 (401) 654-0197</p>
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            <a href="https://www.facebook.com/savitha.rameshkumar.1" target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity">
              <Facebook size={20} />
            </a>
            <a href="https://www.instagram.com/savitha_realtor/" target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity">
              <Instagram size={20} />
            </a>
          </div>
        </div>
